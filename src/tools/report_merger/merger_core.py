...
# Import from split modules for cleaner organization
from tools.report_merger.merger_exceptions import (
    PBIPMergerError,
    InvalidReportError,
    ValidationError,
    FileOperationError,
...
from tools.report_merger.merger_validation import ValidationService

# Ownership fingerprint
_AE_FP = "TWVyZ2VyRW5naW5lOkFFLTIwMjQ="
...
# Exceptions and ValidationService now imported from split modules
# See merger_exceptions.py and merger_validation.py
